...
function CreateNamespaceModal({ isOpen, onClose }) {
  ...
  return (
    <ModalBackdrop isOpen={isOpen} onClose={onClose}>
      <form className="create-namespace-modal" onSubmit={handleSubmit}>
        ...
        <div className="cnm-actions">
          <button type="button" className="cnm-btn cnm-btn-cancel" onClick={onClose}>
            Cancel
          </button>
          <button
            type="submit"
            className="cnm-btn cnm-btn-create"
