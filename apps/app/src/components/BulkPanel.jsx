  ...
  return (
    <>
      ...
      <section className="control-section" role="group" aria-labelledby="links-label">
        <label id="links-label" className="control-label" htmlFor="bulk-links">Your Links</label>
        <div
      ...
      <section className="control-section" role="group" aria-labelledby="format-label">
        <span id="format-label" className="control-label">Export Format</span>
      ...
      {/* Colors */}
      <section className="control-section" role="group" aria-labelledby="bulk-colors-label">
        <span id="bulk-colors-label" className="control-label">Colors</span>
      ...
      {/* Logo */}
      <section className="control-section" role="group" aria-labelledby="bulk-logo-label">
        <span id="bulk-logo-label" className="control-label">Logo</span>
        {logo ? (
          ...
          <button
            ...
            onClick={() => { logoInputRef.current?.click(); trigger('nudge') }}
          >
            <input ref={logoInputRef} type="file" accept="image/*" onChange={handleLogoUpload} hidden aria-label="Upload logo image" />
            <span>Add logo</span>
          </button>
        )}
      </section>
      ...
      {/* Dot Style */}
      <section className="control-section" role="group" aria-labelledby="bulk-dotstyle-label">
        <span id="bulk-dotstyle-label" className="control-label">Dot Style</span>
        <div
          className="dot-row"
          ref={dotRowRef}
          role="radiogroup"
      ...
      <section className="control-section" role="group" aria-labelledby="bulk-size-label">
        <div className="control-header">
          <span id="bulk-size-label" className="control-label">Size</span>
